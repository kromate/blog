Array.prototype.forEach.call(document.querySelectorAll('form[data-members-form]'), function (form){
    ...
    function submitHandler(event) {
        ...
        fetch('http://avant.gbjsolution.com/ghost/api/canary/members/send-magic-link/', {
            method: 'POST',
            headers: {
...
Array.prototype.forEach.call(document.querySelectorAll('[data-members-plan]'), function (el) {
    ...
    function clickHandler(event) {
        ...
        fetch('http://avant.gbjsolution.com/members/ssr', {
            ...
            return fetch('http://avant.gbjsolution.com/ghost/api/canary/members/create-stripe-checkout-session/', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
